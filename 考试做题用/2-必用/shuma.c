...
//	if(key_s5_flag == 2 && key_s4_flag == 2 && locate==7)
//		P0=shumabox[number]&0x7f;
//	else if(key_s5_flag == 1 && key_s4_flag == 0 && locate==6)
//		P0=shumabox[number]&0x7f;
//	else if(key_s4_flag == 0 && locate==2)
//		P0=shumabox[number]&0x7f;
//	else P0=shumabox[number];
